...
export default function AppSidebar({
  ...
  return (
    ...
    <aside
      ...
      className={`shrink-0 flex flex-col border-r border-border bg-sidebar transition-all duration-200 ${
    ...
    >
      ...
      <div className="p-2 border-t border-border space-y-1">
        ...
        <div className="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-muted-foreground">
        ...
        {authed && !collapsed && (
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-3 py-2 rounded-xl text-xs text-muted-foreground hover:bg-muted hover:text-foreground transition-colors"
