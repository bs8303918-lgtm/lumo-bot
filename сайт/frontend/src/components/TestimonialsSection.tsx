...
const LUMO_TESTIMONIALS: Testimonial[] = [
  ...
  {
    text: 'Пользуюсь постоянно. Уже 3 хакатона нашёл через него и зарегался. Раньше бы просто пропустил, потому что каналы мониторить лень. Вот это и есть главная фишка для меня.',
    name: 'Alikhan',
  },
  {
